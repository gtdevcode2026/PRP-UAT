...
window.Reports.d2 = async function d2(wb) {
  ...
  if (yearLoosened) {
    lines.push('  ^ No Cyber row is dated 2026, so this report covers ' + yearUsed + ' instead.' +
  ...
  if (dateFilterDropped) {
    lines.push('  ^ Not one Cyber row has a readable "Date created", so the date filter was dropped' +
